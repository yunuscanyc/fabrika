...
let memAraclar: any[] = [
  {
    AracId: 101,
    PlakaVeyaKod: '07 RND 45',
    AracTipi: 'Kamyonet / Sevkiyat',
    MarkaModel: 'Ford Transit 350L Panelvan',
    ModelYili: 2022,
    SasiSeriNo: 'WF0XXXTTFXP123456',
    ZimmetliKisi: 'Ahmet Yılmaz',
    Departman: 'Sevkiyat & Lojistik',
    GuncelKmVeyaSaat: 84500,
    BakimAraligiKmVeyaSaat: 15000,
    BakimAraligiAy: 12,
    SonBakimTarihi: '2026-03-10',
    SonBakimKmVeyaSaat: 75000,
    SaatTakibiMi: false,
    MuayeneTarihi: '2025-10-15',
    MuayeneGecerlilikYil: 1,
    MuayeneBitisTarihi: '2026-10-15',
    SigortaSirketi: 'Türkiye Sigorta',
    SigortaPoliceNo: 'POL-3489201',
    SigortaBitisTarihi: '2026-11-20',
    KaskoSirketi: 'Allianz Sigorta',
    KaskoPoliceNo: 'KAS-8812903',
    KaskoBitisTarihi: '2026-11-20',
    Durum: 'Faal',
    AktifMi: true,
    Notlar: 'Kasa içi koruma suntası kaplandı. Lastikler iyi durumda.',
    BakimGecmisi: [
      {
        BakimId: 1,
        AracId: 101,
        BakimTarihi: '2026-03-10',
        YapilanKmVeyaSaat: 75000,
        Aciklama: '75.000 KM Ağır Bakım: Motor yağı, tüm filtreler ve ön balatalar değişti',
        Maliyet: 8500,
        YapanUstaVeyaServis: 'Ford Yetkili Servis',
        Belgeler: [],
        FotoSayisi: 0
      }
    ]
  ...
  {
    AracId: 102,
    PlakaVeyaKod: '07 FAB 88',
    AracTipi: 'Kamyon (Ağır Vasıta)',
    MarkaModel: 'Isuzu NPR 3D Kapalı Kasa',
    ModelYili: 2021,
    SasiSeriNo: 'NPR75L-984712',
    ZimmetliKisi: 'Mehmet Demir',
    Departman: 'Sevkiyat & Lojistik',
    GuncelKmVeyaSaat: 142000,
    BakimAraligiKmVeyaSaat: 20000,
    BakimAraligiAy: 12,
    SonBakimTarihi: '2025-12-05',
    SonBakimKmVeyaSaat: 130000,
    SaatTakibiMi: false,
    MuayeneTarihi: '2025-09-20',
    MuayeneGecerlilikYil: 1,
    MuayeneBitisTarihi: '2026-09-20',
    SigortaSirketi: 'Anadolu Sigorta',
    SigortaPoliceNo: 'POL-9921827',
    SigortaBitisTarihi: '2026-10-05',
    KaskoSirketi: 'Axa Sigorta',
    KaskoPoliceNo: 'KAS-441920',
    KaskoBitisTarihi: '2026-10-05',
    Durum: 'Faal',
    AktifMi: true,
    Notlar: 'Lift bakımı düzenli yapılıyor. Şehir dışı sevkiyat aracı.',
    BakimGecmisi: []
  },
  {
    AracId: 103,
    PlakaVeyaKod: 'FK-01',
    AracTipi: 'Forklift (Dizel/Elektrik)',
    MarkaModel: 'Linde H30D Dizel Forklift (3 Ton)',
    ModelYili: 2020,
    SasiSeriNo: 'H2X393G00192',
    ZimmetliKisi: 'Ali Kurt',
    Departman: 'Üretim & İmalat',
    GuncelKmVeyaSaat: 2450,
    BakimAraligiKmVeyaSaat: 250,
    BakimAraligiAy: 6,
    SonBakimTarihi: '2026-02-15',
    SonBakimSaati: 2250,
    SonBakimKmVeyaSaat: 2250,
    SaatTakibiMi: true,
    MuayeneTarihi: '2025-06-01',
    MuayeneGecerlilikYil: 1,
    MuayeneBitisTarihi: '2026-06-01',
    SigortaSirketi: 'Türkiye Sigorta',
    SigortaPoliceNo: 'ISG-77123',
    SigortaBitisTarihi: '2027-01-01',
    KaskoSirketi: '',
    KaskoPoliceNo: '',
    KaskoBitisTarihi: null,
    Durum: 'Faal',
    AktifMi: true,
    Notlar: 'Fabrika içi ve sevkiyat yükleme alanı ana forklifti.',
    BakimGecmisi: []
  }
];
